...
for i in range(0, num_rows):
    CPI_table[i].append(average_CPI_of_each_year[i])
...
for i in range(0, num_rows):
    CPI_table[i].append(median_of_each_year[i])
...
for i in range(0, num_rows):
    CPI_table[i].append(standard_deviation_of_each_year[i])
...
degree = 4 #degree of the fitting polynomial
model_polynomial_for_average_CPI_of_each_year = numpy.poly1d(numpy.polyfit(years, average_CPI_of_each_year, degree))
print("model_polynomial_for_average_CPI_of_each_year:")
print(model_polynomial_for_average_CPI_of_each_year)

data_for_model_polynomial_for_average_CPI_of_each_year = []

num_points = len(time_line)
for i in range(0, num_points):
    x = time_line[i]
    data_for_model_polynomial_for_average_CPI_of_each_year.append(model_polynomial_for_average_CPI_of_each_year(x))
...
#and to draw a line of polynomial regression
degree = 4 #degree of the fitting polynomial
model_polynomial_for_monthly_CPI = numpy.poly1d(numpy.polyfit(time_line, monthly_CPI, degree))
print("model_polynomial_for_monthly_CPI:")
print(model_polynomial_for_monthly_CPI)

data_for_model_polynomial_for_monthly_CPI = []

num_points = len(time_line)
for i in range(0, num_points):
    data_for_model_polynomial_for_monthly_CPI.append(model_polynomial_for_monthly_CPI(time_line[i]))
...
plt.plot(time_line , data_for_model_polynomial_for_average_CPI_of_each_year, color = "orange", label = "model polynomial for average annual CPI")

plt.plot(time_line , data_for_model_polynomial_for_monthly_CPI, color = "lightblue", label = "model polynomial for monthly CPI")
